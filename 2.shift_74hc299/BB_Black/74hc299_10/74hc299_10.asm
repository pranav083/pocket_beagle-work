...
start:
	...
	MOV r6.b0, 0b11110000 		// MOVE F0 INITIAL VALUE TO R6 
	...
	MOV r4, GPIO1 | GPIO_CLEARDATAOUT //clear the bit at data pin	
	MOV r5, GPIO1 | GPIO_SETDATAOUT   //set   the bit at data pin
