...
start:
	...
	MOV r6.b0, 0b00000000 			// MOVE 0 INITIAL VALUE TO R6 
...
//////////////////////////////////////////////////////////////////
	...
	MOV  r2, 1 << 13     			//move out pin to p8_11 
...
BIT_D:  	
	...
	MOV r1, 50000000                    	// set up for a .5 second delay
...
BIT_SET:
	...
	SBBO r7, r5, 0, 4   			// the p8_16 pin is HIGH        
        ...
        MOV r1, 20000000                    	// set up for a .2 second delay
...
////////////////////////////////////////////////////////////
	...
	MOV r1,  90000000                    	// set up for  the delay				
...
L2:     SUB r1, r1, 1                       	// subtract 1 from R1
	...
	MOV r1,  90000000                    	// set up for  the delay				
        ...
        // perform a LOOP for delay
L22:     SUB r1, r1, 1                       	// subtract 1 from R1
        QBNE L222, r1, 0                      	// is R1 == 0? if no, then goto L1
	...
	MOV r1,  90000000                    	// set up for  the delay				
        ...
        // perform a LOOP for delay
L222:     SUB r1, r1, 1                       	// subtract 1 from R1
        QBNE L222, r1, 0                      	// is R1 == 0? if no, then goto L1        
...
OUT:
	...
	MOV r1, 90000000                    	// set up for a .9 second delay				
        ...
        // perform a LOOP for delay
LO3:     SUB r1, r1, 1                       	// subtract 1 from R1
       QBNE LO3, r1, 0                      	// is R1 == 0? if no, then goto L1
