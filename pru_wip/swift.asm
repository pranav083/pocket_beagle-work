...
#define SRCLR 13 /* P8_11 45 GPIO 1_13 mode 7 */ 
#define SRCLK 12 /* P8_12 44 GPIO 1_12 mode 7 */
#define OE    23 /* P8_13 23 GPIO 0_23 mode 7 */
#define RCLK  15 /* P8_15 47 GPIO 1_15 mode 7 */
#define SER   14 /* P8_16 46 GPIO 1_14 mode 7 */
#define CPRUCFG  c4
...
start:
	...
	//Setting the value for the register FOR Output enable register
	...
	//Setting the value for the register serial clear register
